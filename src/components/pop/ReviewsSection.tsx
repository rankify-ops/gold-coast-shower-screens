...
function Card({
  ...
  return (
    ...
    <figure className="mr-5 flex w-[320px] flex-none flex-col rounded-2xl border border-[color:var(--rule)] bg-white p-6 shadow-[0_16px_40px_-28px_rgba(0,38,61,0.45)]">
      ...
      />
      <blockquote className="mt-4 flex-1 text-[14px] leading-[1.6] text-[color:var(--ink)]">
        &ldquo;{quote}&rdquo;
      </blockquote>
      <figcaption className="mt-5 flex items-center justify-between gap-4 border-t border-[color:var(--rule)] pt-5 text-[11px] font-medium uppercase tracking-[0.14em]">
        <span className="text-[color:var(--ink)]">{name}</span>
        {source ? <span className="text-[color:var(--ink-3)]">{source}</span> : null}
      </figcaption>
    </figure>
  );
}
      ...
      <div className="relative flex flex-wrap items-end justify-between gap-10 px-8 pb-14 pt-24 lg:px-14 lg:pt-32">
        <div>
          ...
          >
            ...
            <span className="text-[color:var(--ink-3)]">Here are nine.</span>
          </h2>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <div>
            <Stars
              ...
              className="gap-[4px] text-[color:var(--gold)]"
            />
            <p className="mt-3 text-[11px] font-medium uppercase tracking-[0.14em] text-[color:var(--ink)]">
