  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-wrap items-end justify-between gap-8 px-8 pt-10 lg:px-14">
          <div>
            ...
            >
              ...
              <span className="text-[color:var(--navy)]/45">No two identical.</span>
            </h2>
          </div>
          ...
          <div className="flex items-center gap-8">
            ...
            <p className="hidden text-[11px] font-medium uppercase tracking-[0.14em] text-[color:var(--navy)]/45 lg:block">
              ...
              <figure key={item.name} className="group relative flex-none snap-start">
                ...
                */}
                ...
                >
                  ...
                  />
                  <span className="absolute left-4 top-4 bg-white/85 px-2.5 py-1 text-[11px] font-medium uppercase tracking-[0.14em] text-[color:var(--navy)] backdrop-blur-sm">
                    {String(i + 1).padStart(2, "0")}
                  </span>
                </div>

                <figcaption className="mt-4 flex flex-wrap items-center justify-between gap-3 border-t border-[color:var(--navy)]/12 pt-4">
                  <span className="text-[11px] font-medium uppercase tracking-[0.14em] text-[color:var(--navy)]">
                    {item.name}
                  </span>
                  <span className="rounded-full border border-[color:var(--navy)]/25 px-3 py-1.5 text-[11px] font-medium uppercase tracking-[0.14em] text-[color:var(--navy)]">
                    {item.finish}
                  </span>
                </figcaption>
              </figure>
        ...
        <div className="mx-8 mb-6 h-px bg-[color:var(--navy)]/12 lg:mx-14">
          <div
